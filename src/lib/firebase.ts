...
// CRITICAL: Must use the custom database ID from config to avoid breaking the Firestore connection
export const db = getFirestore(app, firebaseConfig.firestoreDatabaseId);
export const auth = getAuth(app);

// Strict Error Handling as required by Firebase Skill Instructions
